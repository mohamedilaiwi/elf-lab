...
void get_virtual_address(char *pid, char *section, long *starting_address, long *ending_address, char *perms);    // returns the virtual address range of the PID inside the heap given its process ID
