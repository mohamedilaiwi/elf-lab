...
void get_virtual_address(char *pid, long *starting_address, long *ending_address);    // returns the virtual address range of the PID inside the heap given its process ID
